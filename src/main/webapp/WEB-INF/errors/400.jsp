...
<section>
    ...
    <h1>400 Bad Request — the server can’t process the request because it’s malformed or invalid (e.g., bad JSON,
        missing/invalid parameters, wrong syntax).</h1>
